...
<%@page import="com.cyj.core.web.controller.*"%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="div_choice" class="choice_merch">
			<h2 id="cart_tips">
				您已选购以下商品<span style="color:red">${cart_empty}</span>o
					...
					<tr class='objhide' over="no">
                      ...
                      <c:forEach items="${ciBuy }" var="ci">
						<tr class='td_no_bord'>
							...
							<td>
							<a href="<%=basePath%>main/book_view?id=${ci.pro.id }">${ci.pro.product_name }</a>
							</td>
							<td>
								<a href="<%=basePath%>dangdang/main/book_view?id=${ci.pro.id }"><IMG id=img_show_prd
										src="${pageContext.request.contextPath}/productImages/${ci.pro.product_pic }" width="75px"></td>
							<td class="buy_td_5">
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						...
						<div id="balance" class="balance">
							<a name='checkout' href='${pageContext.request.contextPath}/order/confirm' > 
