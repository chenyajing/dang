					...
					<DIV class=right_wai>
						<DIV class=shuming>
							<DIV class=shuming_left>
								...
								<SPAN class=black000><A name=top_bk></A>${book.product.product_name
									}</SPAN>
							</DIV>
							<DIV class=book_case>
								<SPAN class=seriesname>丛书名： ${book.product.product_name }</SPAN>
							</DIV>
						...
						<DIV class=book_left>
							<DIV class=book_pic>
								<IMG id=img_show_prd
										src="${pageContext.request.contextPath }/productImages/${product.book.product_pic }">
								</A>
							</DIV>
						...
						<DIV class=book_right>
							...
							<DIV class=jiage>
								<SPAN class=gray87>定价：<SPAN class=del id=originalPriceTag>￥${book.product.fixed_price
										}</SPAN>
								</SPAN>
								<SPAN class=redc30>当当价：￥<B>${book.product.dang_price }</B>
...
<IMG id=imgfavor src="<%=basePath%>product_files/bookz_save.gif"></A>
-->
								</DIV>
